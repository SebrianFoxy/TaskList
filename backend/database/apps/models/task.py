...
from sqlalchemy.types import DateTime, String, Integer, Boolean, JSON
...
class Task(ModelExtension):
    ...
    sent_reminders = Column(JSON, default=list)
    ...
    @classmethod
    def get_all_task(cls, id, error_msg='Task not found'):
