...
part 'card/subscribe_card.dart';

// Кнопки
part 'button/add_task_button.dart';
part 'button/bottom_navigation_bar.dart';
part 'button/create_account_button.dart';
part 'button/link_profile_button.dart';
part 'button/telegram_code_button.dart';
part 'button/unlink_profile_button.dart';

//Диалоги
part 'dialog/dialog_add_task.dart';
part 'dialog/dialog_delete_task.dart';
part 'dialog/dialog_error.dart';
part 'dialog/dialog_telegram_link.dart';
part 'dialog/dialog_telegram_unlink.dart';
